...
# 报时
TELL_TIME = {
    "BILIAN_GROUP_ID_LIST":(463222048, 476957090, 256363413),  # 碧蓝群
    "GROUP_ID_LIST":(670518695, 483985370, 945098403)  # 普通群
    }

# 动态
DYNAMIC_SUBSCRIBE = {
    "GROUP_LIST":(463222048, 787211538, 476957090), # 已订阅群列表
    "UID_LIST" :('300123440', '233114659')  # B站动态订阅源 UID列表
    }