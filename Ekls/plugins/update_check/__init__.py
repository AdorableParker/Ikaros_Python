...
async def _():
    ...
    # 火星时报
    group_list = sql_read("User.db", "group_info", "Sara_news", True, field = "group_id", in_where = True)
    if not group_list:
    ...
    # 标枪快讯
    group_list = sql_read("User.db", "group_info", "Javelin_news", True, field = "group_id", in_where = True)
    if not group_list:
